 ...
 */
export function createVirtualTimelineSystem(config?: Partial<VirtualTimelineConfig>) {
  ...
  return {
     ...
     * 전체 시스템 초기화
     */
    initialize: (clips: import('../../app/(route)/editor/types').ClipItem[]) => {
