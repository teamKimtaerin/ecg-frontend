...
import { YouTubeUploadRequest, UploadProgress } from '@/app/(route)/editor/components/Export/ExportTypes'
...
export class YouTubeApiUploader {
   ...
   * 비디오 업로드
   */
  async uploadVideo(request: YouTubeUploadRequest & { videoPath: string }): Promise<{
    success: boolean
    videoUrl?: string
    videoId?: string
    error?: string
